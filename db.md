...
* все атрибуты атомарны (минимально возможную единицу данных, то есть быть неделимым, поле phone не может содеражть несколько номеров телеыона в одном кортеже если атрибуты атомарны )
...
* Неключевые атрибуты напрямую зависят только от РК, но не от других атрибутов
...
[ACID Youtube](https://www.youtube.com/watch?v=gOB3hpAVIIQ) 
